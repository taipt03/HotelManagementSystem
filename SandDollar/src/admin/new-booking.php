                                                ...
                                                <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            ...
                                                            $sql="SELECT tbluser.*,tblbooking.bookingnumber,tblbooking.status,tblbooking.bookingdate from tblbooking 
                                                            join tbluser on tblbooking.userid=tbluser.id where tblbooking.status is NULL 
