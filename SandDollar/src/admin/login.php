...
<head>
	<title>Sand Dollar Hotel Admin | login page</title>
							...
							<div class="registration_left">
								...
								<div class="registration_form">
									...
									<form method="post">
										<div>
											<label>
												<input placeholder="Username" type="text" required="true" name="username" style="border:solid #000 1px;" value="<?php if (isset($_COOKIE["user_login"])) {
										...
										<div>
											<label>
												<input placeholder="password" type="Password" name="password" required="true" style="border:solid #000 1px;" value="<?php if (isset($_COOKIE["userpassword"])) {
