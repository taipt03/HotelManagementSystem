...
<html>
    <head>
        <title>Sand Dollar Hotel Admin | Approved Booking</title>
						            ...
						            <div class="forms">
							            <div class="form-grids widget-shadow" data-example-id="basic-forms"> 
                                            ...
                                            <?php
                                                ...
                                                $ret = "SELECT COUNT(*) FROM $tableName WHERE status = 'Cancelled'";
                                                $query1 = $dbh->prepare($ret);
                                                $query1->execute();
                                                $total_rows = $query1->fetchColumn();
                                                $total_pages = ceil($total_rows / $no_of_records_per_page);

                                                // Fetch approved booking data with pagination
                                                ...
                                                if ($query->rowCount() > 0) {
                                                    ...
                                                    <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                                        <tbody>
                                                            <tr>
                                                                <td colspan="9" style="color:red; font-size:22px; text-align:center">No approved bookings found</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    <?php
