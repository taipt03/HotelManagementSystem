												...
												<table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
													...
													<tbody>
														...
														<tr>
															...
															<td class="d-none d-sm-table-cell"><span class="badge badge-primary"><?php  echo htmlentities($row->CreationDate);?></span></td>
															<td>
																<a href="edit-room.php?editid=<?php echo ($row->ID);?>" class="btn btn-info btn-sm">Edit</a>
